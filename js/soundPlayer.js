...
// Handlers
playPause === null || playPause === void 0
  ? void 0
  : playPause.addEventListener("click", function () {
      var _a, _b, _c;
      if (audio.paused) {
        audio.play();
        (_a = playPause.firstElementChild) === null || _a === void 0
          ? void 0
          : _a.getAttribute("src");
        (_b = playPause.firstElementChild) === null || _b === void 0
          ? void 0
          : _b.setAttribute("src", "./assets/imgs/Pause.svg");
      } else {
        audio.pause();
        (_c = playPause.firstElementChild) === null || _c === void 0
          ? void 0
          : _c.setAttribute("src", "./assets/imgs/Play.svg");
      }
    });
// auto switch
        ...
        return __generator(this, function (_a) {
          switch (_a.label) {
            case 0:
              ...
              currentSurahString =
                currentSurah === null || currentSurah === void 0
                  ? void 0
                  : currentSurah.slice(-7).slice(0, -4);
